...
ADD https://github.com/dotnet/docfx/releases/download/v2.64.0/docfx-win-x64-v2.64.0.zip /
RUN unzip docfx-win-x64-v2.64.0.zip -d /docfx && \
    rm docfx-win-x64-v2.64.0.zip
